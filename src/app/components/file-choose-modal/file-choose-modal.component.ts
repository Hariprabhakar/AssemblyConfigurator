...
export class FileChooseModalComponent implements OnInit {
  ...
  public FileChooseFrom1: FormGroup = this.formBuilder.group({
    // this form is for first view
    fileupload1: [''],
    fileupload: ['']
  });
  ...
  constructor(
    public fileChoose: MatDialogRef<FileChooseModalComponent>,
  ...
  get items(): FormArray {
    // Get Dynamically injected form fields
