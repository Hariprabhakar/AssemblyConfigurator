...
namespace IdentityService.Services
{
    ...
    public class EmailService : IEmailService
    {
        ...
        public async Task SendEmailAsync(MailRequest mailRequest)
        {
            ...
            email.ReplyTo.Add(MailboxAddress.Parse("noreply@sanveo.com"));
            ...
            await smtp.ConnectAsync(_appSettings.MailSettings?.Host, _appSettings.MailSettings?.Port ?? 0, MailKit.Security.SecureSocketOptions.StartTls);
