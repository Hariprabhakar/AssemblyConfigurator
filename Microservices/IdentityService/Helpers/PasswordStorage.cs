...
namespace IdentityService.Helpers
{
    public class PasswordStorage
    {
        ...
        public static bool VerifyPasswordHash(string password, string base64Hash, string base64Salt)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(password), "Invalid length of password hash (64 bytes expected)");
            }

            if (storedSalt.Length != 128)
            {
                throw new ArgumentOutOfRangeException(nameof(password), "Invalid length of password salt (128 bytes expected).");
            }
